...
from torchseg.modeling.layers.convolutional_direction import DirectionalBlock as ConvolutionalDirectionalBlock
...
class Decoder(torch.nn.Module):
    ...
    def __init__(
        ...
        if angles is not None:
            ...
            self.directional_block = ConvolutionalDirectionalBlock(angles, in_channels=in_channels, out_channels=embed_dim, kernel_size=15)
